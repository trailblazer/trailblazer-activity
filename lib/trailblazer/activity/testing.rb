# DISCUSS: move to trailblazer-activity-test ? (or trailblazer-test ?)
  ...
  module Activity::Testing
    ...
    module Assertions
      ...
      def flat_activity
        ...
        implementation = {
          "Start.default" => Schema::Implementation::Task(
            Implementing::Start,
            [Activity::Output(Activity::Right, :success)], []
          ),
          :B              => Schema::Implementation::Task(
            Implementing.method(:b),
            [Activity::Output(Activity::Right, :success)], []
          ),
          :C              => Schema::Implementation::Task(
      ...
      def nested_activity
        ...
        implementation = {
          ...
          :D              => Schema::Implementation::Task(bc, [Activity::Output(Implementing::Success, :success)], []),
          :E              => Schema::Implementation::Task(
            Implementing.method(:f),
            [Activity::Output(Activity::Right, :success)], []
          ),
          "End.success"   => Schema::Implementation::Task(Implementing::Success, [Activity::Output(Implementing::Success, :success)], []) # DISCUSS: End has one Output, signal is itself?
        }
      ...
      alias bc flat_activity
      alias bde nested_activity
      ...
      def assert_process_for(process, *args)
        ...
        inspects = semantics.collect do |semantic|
          %{#<struct Trailblazer::Activity::Output signal=#<Trailblazer::Activity::End semantic=#{semantic.inspect}>, semantic=#{semantic.inspect}>}
        end
