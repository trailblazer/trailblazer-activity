...
class TaskTest < Minitest::Spec
  ...
  let (:circuit) do
    read    = Circuit::Task::Binary( ->(direction, options, flow_options) { Circuit::Args::KW(Blog::Read).(options, flow_options) } )
    comment = Circuit::Task::Binary( ->(direction, options, flow_options) { Circuit::Args::KW(Blog.method(:comment)).(options, flow_options) } )
    rate    = Circuit::Task::Binary( ->(direction, options, flow_options) { Circuit::Args::KW(:rate).(options, flow_options) } )
